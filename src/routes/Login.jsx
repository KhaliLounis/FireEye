...
const Login = () => {
  ...
  return (
    <div className="h-screen bg-[url('./assets/firebg.png')] flex flex-col ">
      <div>
        <h1 className="text-4xl font-extrabold font-main text-white pt-5 px-7 mb-16">
          FireEye
        </h1>
      </div>
        ...
        <form className="flex flex-col" onSubmit={handleLogin}>
          <div className="relative my-3 self-center">
            <input
              ...
              type="email"
              id="email"
              className="bg-[#80808061] indent-2 pr-24 py-4 rounded outline-blue-600 text-white"
              onChange={(e) => setEmail(e.target.value)}
              value={email}

            />
            <label
              className={`absolute left-2 top-3 text-[#FFFFFF66] cursor-text font-semibold w-5 ${email && '-top-[5px]'}`}
              htmlFor="email"
            >
              Email
            </label>
          ...
          <div className="relative my-3 self-center">
            <input
              ...
              id="password"
              className="bg-[#80808061] rounded text-white pr-24 indent-2 py-4 outline-blue-600"
              onChange={(e) => setPassword(e.target.value)}
              value={password}
            />
            <label
              className={`absolute left-2 top-3 text-[#FFFFFF66] cursor-text font-semibold w-5 ${password && '-top-[5px]'}`}
              htmlFor="password"
            >
              Password
            </label>
          ...
          <div className="self-center">
            <button className="text-white bg-[#1D40F5] p-2 px-10 rounded my-3">
              Login
            </button>
          </div>
        </form>
